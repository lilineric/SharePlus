...
namespace Shoring.SharePlus
{
    ...
    [Guid(GuidList.guidSharePlusPkgString)]
    public sealed class SharePlusPackage : Package
    {
        /// <summary>
        ...
        protected override void Initialize()
        {
            ...
            if (null != mcs)
            {
                ...
                AddMenuCommand(mcs, new EditorPlus(dte, uiShell).Commit, GuidList.guidSharePlusCmdSet, PkgCmdIDList.cmidCommit);
        ...
        private static void AddMenuCommand(OleMenuCommandService mcs, EventHandler handler, Guid menuGroup, uint commandID)
        {
            CommandID menuCommandID = new CommandID(menuGroup, (int)commandID);
