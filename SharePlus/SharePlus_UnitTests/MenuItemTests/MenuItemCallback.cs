...
using Shoring.SharePlus;

namespace SharePlus_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SharePlusPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Shoring.SharePlus.GuidList.guidSharePlusCmdSet, (int)Shoring.SharePlus.PkgCmdIDList.cmdidMyCommand);
